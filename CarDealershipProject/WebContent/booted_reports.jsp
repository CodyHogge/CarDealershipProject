...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  ...
  <ul class="navbar-nav px-3">
	...
	<div class="jumbotron">
    	<div class="container">
      		<h1 class="display-3">This is the Business Reports Page.</h1>
      			<p>This is the page that will provide information on the finance flow of the Car Lot.</p>
    	</div>
 	 </div>
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="booted_reports.jsp">
              ...
              Business Page - Reports <span class="sr-only">(current)</span>
            </a>
          </li>
        </ul>
      </div>
