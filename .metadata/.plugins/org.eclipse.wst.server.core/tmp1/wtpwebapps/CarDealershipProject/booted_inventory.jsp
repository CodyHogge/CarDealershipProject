...
<body>
	...
	<div class="jumbotron">
    <div class="container">
      <h1 class="display-3">The Virtual Lot</h1>
          ...
          <tbody>
          	<c:forEach var="car" items="${inventoryList}">
          		<c:if test="${car.getOwnerDate() == null}">
          			<tr>
              			<td>Picture</td>
              			<td><c:out value="${car.getYear()} ${car.getMake()} ${car.getModel()}"></c:out></td>
              			<td><c:out value="${car.getOdometer()}"></c:out></td>
              			<td><c:out value="${car.getCondition()}"></c:out></td>
              			<td><c:out value="${car.getMsrp()}"></c:out></td>
            		</tr>
            	</c:if>
          	</c:forEach>
          </tbody>
